...
type structWithTruncated struct {
	A, B uint
	C    []byte `rlp:"truncated"`
}

func ExampleDecode_structTagTruncated() {
	var val structWithTruncated
	...
	// Output:
	// with 4 elements: err=<nil> val={1 2 [194 3 4]}
	// with 6 elements: err=<nil> val={1 2 [196 3 4 5 6]}
	// with 1 element: err="rlp: too few elements for rlp.structWithTruncated"
}
